...
public class XYMultipleSeriesRenderer extends DefaultRenderer {
  ...
  private boolean xAxisBold = false;
  private boolean yAxisBold = false;
  /**
...
public boolean isXAxisBold() {
	return xAxisBold;
}

public void setXAxisBold(boolean xAxisBold) {
	this.xAxisBold = xAxisBold;
}

public boolean isYAxisBold() {
	return yAxisBold;
}

public void setYAxisBold(boolean yAxisBold) {
	this.yAxisBold = yAxisBold;
}
