...
import org.achartengine.chart.OrderedXYChart;
...
public class ChartFactory {
  ...
  public static final Intent getOrderedXYChartIntent(Context context, XYMultipleSeriesDataset dataset,
	      XYMultipleSeriesRenderer renderer) {
	    return getOrderedXYChartIntent(context, dataset, renderer, "");
  }
  ...
  public static final Intent getOrderedXYChartIntent(Context context, XYMultipleSeriesDataset dataset,
    ...
    checkParameters(dataset, renderer);
    Intent intent = new Intent(context, GraphicalActivity.class);
    XYChart chart = new OrderedXYChart(dataset, renderer);
    intent.putExtra(CHART, chart);
    intent.putExtra(TITLE, activityTitle);
    return intent;
  }
